			...
			<div>
				<center>
					<form onSubmit={this.handleSubmit}>
						...
						type="text" value={this.state.pesanan} ref={this.pesanan} placeholder="Masukkan Pesanan Anda"
						/>
						<input onChange={(e)=> this.handleChangeJumlah(e)}
						type="number" value={this.state.jumlah} placeholder="Masukkan Jumlah Pesanan"
						/>
						<br /> <br />
